...
Install()
{
  ...
  if hash btpip 2>/dev/null; then
	...
	wget -O /www/server/panel/plugin/alioss/alioss_main.py $download_Url/install/plugin/alioss/alioss_main2.py -T 5
	wget -O /www/server/panel/plugin/alioss/index.html $download_Url/install/plugin/alioss/index2.html -T 5
	wget -O /www/server/panel/plugin/alioss/info.json $download_Url/install/plugin/alioss/info2.json -T 5
