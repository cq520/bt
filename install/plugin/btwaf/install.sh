...
Install_sqlite3_for_nginx()
{
    ...
    if [ true ];then
        ...
        if [ ! -f '/tmp/lsqlite3_fsl09y/lsqlite3.so' ];then
            echo $tip9
            wget -c -o /www/server/btwaf/lsqlite3.so http://download.bt.cn/btwaf_rule/test/btwaf/lsqlite3.so -T 10
        else
            echo $tip10
...
install_mbd(){
	if [ ! -f '/www/server/btwaf/GeoLite2-City.mmdb' ];then
		wget -c -O /www/server/btwaf/GeoLite2-City.mmdb.tar.gz $download_Url/btwaf_rule/test/btwaf/GeoLite2-City.mmdb.tar.gz -T 10
		cd /www/server/btwaf/ && tar zxvf GeoLite2-City.mmdb.tar.gz
		rm -rf /www/server/btwaf/GeoLite2-City.mmdb.tar.gz
	fi
	if [ ! -f '/www/server/btwaf/GeoLite2-City.mmdb' ];then
		wget -c -O /www/server/btwaf/GeoLite2-City.mmdb $download_Url/btwaf_rule/test/btwaf/GeoLite2-City.mmdb -T 10
	fi
}
...
install_static()
{
	...
	wget -O $pluginPath/templates/index.html $download_Url/btwaf_rule/test/btwaf/templates/index.html -T 5
	wget -O $pluginPath/templates/error4.html $download_Url/btwaf_rule/test/btwaf/templates/error4.html -T 5
	rm -rf $pluginPath/static/*
	wget -O $pluginPath/static/static.zip $download_Url/btwaf_rule/test/btwaf/static/static.zip
...
{ 
	...
	if [ "$aacher" == "aarch64" ];then 
		...
		if [  -f /www/server/panel/pyenv/bin/python ];then
			wget -O $pluginPath/btwaf_main.cpython-37m-x86_64-linux-gnu.zip $download_Url/btwaf_rule/test/btwaf/8.9.0/btwaf_main.cpython-37m-x86_64-linux-gnu$en.zip -T 5
			...
			if [ "$pyVersion" == 2 ];then
				wget -O $pluginPath/btwaf_main.zip $download_Url/btwaf_rule/test/btwaf/8.9.0/btwaf_main$en.zip -T 5
				unzip -o $pluginPath/btwaf_main.zip -d $pluginPath > /dev/null
				rm -rf $pluginPath/btwaf_main.zip
			else
				if [ "$py_zi" == 6 ];then 
					wget -O $pluginPath/btwaf_main.cpython-36m-x86_64-linux-gnu.zip $download_Url/btwaf_rule/test/btwaf/8.9.0/btwaf_main.cpython-36m-x86_64-linux-gnu$en.zip -T 5
	...
	wget -O $pluginPath/btwaf_main.zip $download_Url/btwaf_rule/test/btwaf/8.9.0/btwaf_main$en.zip -T 5
	wget -O $pluginPath/totle_db.py $download_Url/btwaf_rule/test/btwaf/8.9.0/totle_db.py -T 5
	wget -O $pluginPath/totle_db2.py $download_Url/btwaf_rule/test/btwaf/8.9.0/totle_db2.py -T 5
	...
	wget -O $pluginPath/firewalls_list.py $download_Url/btwaf_rule/test/btwaf/firewalls_list.py -T 5
	wget -O $pluginPath/index.html $download_Url/btwaf_rule/test/btwaf/8.7.1/index$en.html -T 5
	wget -O $pluginPath/info.json $download_Url/btwaf_rule/test/btwaf/info$en.json -T 5
	...
	wget -O $pluginPath/btwaf.zip $download_Url/btwaf_rule/test/btwaf/btwaf$en.zip -T 5
...
Upload_btwaf()
{
  en=''
	...
	echo '正在安装脚本文件...' > $install_tmp
	if [ "$pyVersion" == 2 ];then
		wget -O $pluginPath/btwaf_main.zip $download_Url/btwaf_rule/test/btwaf/btwaf_main$en.zip -T 5
		unzip -o $pluginPath/btwaf_main.zip -d $pluginPath > /dev/null
		rm -rf $pluginPath/btwaf_main.zip
	else
		wget -O $pluginPath/btwaf_main.cpython-34m.zip $download_Url/btwaf_rule/test/btwaf/btwaf_main.cpython-34m$en.zip -T 5
		unzip -o $pluginPath/btwaf_main.cpython-34m.zip -d $pluginPath > /dev/null
		rm -rf $pluginPath/btwaf_main.cpython-34m.zip
		wget -O $pluginPath/btwaf_main.cpython-36m-x86_64-linux-gnu.zip $download_Url/btwaf_rule/test/btwaf/btwaf_main.cpython-36m-x86_64-linux-gnu$en.zip -T 5
		unzip -o $pluginPath/btwaf_main.cpython-36m-x86_64-linux-gnu.zip -d $pluginPath > /dev/null
		rm -rf $pluginPath/btwaf_main.cpython-36m-x86_64-linux-gnu.zip
	fi
	wget -O $pluginPath/rule.json $download_Url/btwaf_rule/test/btwaf/rule.json -T 5
	...
	wget -O $pluginPath/btwaf_main.py $download_Url/btwaf_rule/test/btwaf/btwaf_main.py -T 5
	wget -O $pluginPath/firewalls_list.py $download_Url/btwaf_rule/test/btwaf/firewalls_list.py -T 5
	wget -O $pluginPath/index.html $download_Url/btwaf_rule/test/btwaf/index$en.html -T 5
	wget -O $pluginPath/info.json $download_Url/btwaf_rule/test/btwaf/info$en.json -T 5
	wget -O $pluginPath/icon.png $download_Url/btwaf_rule/test/btwaf/icon.png -T 5
	wget -O /www/server/panel/vhost/nginx/btwaf.conf $download_Url/btwaf_rule/test/btwaf/btwaf.conf -T 5
	\cp -a -r /www/server/panel/plugin/btwaf/icon.png /www/server/panel/static/img/soft_ico/ico-btwaf.png
